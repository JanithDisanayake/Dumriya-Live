...
exports.getById = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "An error occurred while fetching the train." });
  }
};
...
exports.register = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: "An error occurred while registering the train",
      error: error.message,
    });
  }
};
...
exports.update = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: "An error occurred while updating the train",
      error: error.message,
...
exports.getLive = async (req, res) => {
  try {
    ...
    res.status(500).json({
      message: "An error occurred while retrieving live train data",
      error: error.message,
    });
  }
};
...
exports.getLiveById = async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).json({
      message: "An error occurred while fetching the live train data",
      error: error.message,
    });
  }
};
